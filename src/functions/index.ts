...
export {createBrand,getAllBrands,getBrandsByPK,deleteBrandsByPK,updateBrandsByPK } from './lambdas/brand'
// export {createModel,deleteModelByPK,getAllModel,getModelByPK,updateModelByPK} from './lambdas/model'

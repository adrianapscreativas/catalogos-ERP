...
const modelFilter = (queryStringParameters) => {
  ...
  let { per_page, page,name, id_brand ,status} = queryStringParameters;
...
console.log("chale",id_brand);
  if (undefined !== id_brand && null !== id_brand) {
    params ={
      ...params,
      id_brand
    };
